...
The purpose of this analysis is to craft a machine learning algorithm
to assist the sorting process of wheat seeds in the food industry. In this analysis,
we will be constructing the best classification algorithm for "Seeds", a dataset
...
The data can be found on UCI's Machine Learning repository:
